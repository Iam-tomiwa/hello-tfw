...
export default function MainClient({ initialMessages }: Props) {
  ...
  const handlePasscodeSuccess = useCallback((code: string, role: 'her' | 'admin') => {
  ...
  return (
    <div className="min-h-screen font-sans" style={{ background: '#fdf6f0' }}>
      <AnimatePresence>
      ...
      >
        <div>
          <h1 className="font-serif text-lg font-semibold" style={{ color: '#2d1b2e' }}>
            The Fiery Woman
          </h1>
          <p className="text-[11px] font-sans tracking-wider" style={{ color: '#a8729a' }}>
            your comfort corner 🌸
          </p>
        </div>
      ...
      <main className="px-5 sm:px-10 py-10 max-w-5xl mx-auto">
        ...
        >
          <h2 className="font-serif text-3xl sm:text-4xl font-bold" style={{ color: '#2d1b2e' }}>
            Messages for You
          </h2>
